...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   map_graphics_handling.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hbarda <hbarda@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/06/09 11:41:42 by hbarda            #+#    #+#             */
/*   Updated: 2024/06/09 11:56:58 by hbarda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (data->map[i][j] == '1')
		mlx_put_image_to_window(data->mlx_ptr, data->mlx_window, data->wall,
			j * 30, i * 30);
	else if (data->map[i][j] == '0')
		mlx_put_image_to_window(data->mlx_ptr, data->mlx_window, data->floor,
			j * 30, i * 30);
	else if (data->map[i][j] == 'E')
		mlx_put_image_to_window(data->mlx_ptr, data->mlx_window, data->exit,
			j * 30, i * 30);
	else if (data->map[i][j] == 'C')
		mlx_put_image_to_window(data->mlx_ptr, data->mlx_window, data->flame,
			j * 30, i * 30);
}
